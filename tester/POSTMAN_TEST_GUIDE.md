...
Yeni collection: `SigortaBackend`
...
### E) Güvenlik ve Hata Yakalma

21. `POST {{base_url}}/auth/register/` (Geçersiz E-posta: "bozuk-format") -> `400`
21. `POST {{base_url}}/auth/register/` (Zayıf Şifre: "123") -> `400`
21. `POST {{base_url}}/auth/register/` (Çakışan Kullanıcı Adı: "demo") -> `400`
